<!--This is sample page for testing-->
...
<body>
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0" background="image/topbkg.jpg">
    <tr>
      ...
      <td width="10%">
        <img border="0" src="image/topright.jpg" width="203" height="68" align="right">
      </td>
    </tr>
  </table>
  ...
  <table width="304" border="0" align="center">
    <tr>
      <td width="298">
        <div align="left"><strong> Q-1</strong> <strong>: What is not Php Element?</strong></div>
      </td>
    </tr>
    <tr>
      <td>
