<!--This program is used to show the already given test result by student-->
<?php
//Session started
session_start();
?>
...
include("header.php");
//Daabase file included
include("database.php");
//Extratedd the session  variable
extract($_SESSION);
//Get all test result given by student
